...
HANDLER = "alc.ocr_proofread.document.v1"
BOUNDARY_REPAIR_HANDLER = "alc.ocr_proofread.boundary_repair.v1"
PROMPT_VERSION = "alc.ocr_proofread.page_prompt.v6"
BOUNDARY_PROMPT_VERSION = "alc.ocr_proofread.boundary_prompt.v1"
BOUNDARY_REPAIR_REQUEST_SCHEMA = "alc.ocr_proofread.boundary_repair_request.v2"
RESULT_SCHEMA = "alc.ocr_proofread.result.v1"
PAGE_SCHEMA = "alc.ocr_proofread.page_result.v1"
REVIEW_SCHEMA = "alc.ocr_proofread.review_request.v1"
AUDIT_SCHEMA = "alc.ocr_proofread.audit_request.v1"
GROUP_ID = "pages"
BOUNDARY_GROUP_ID = "boundaries"
BOUNDARY_IMAGE_GROUP_ID = "boundary-page-images"
BOUNDARY_REVIEW_SCHEMA = "alc.ocr_proofread.boundary_review_request.v3"
...
class ProofreadConfig:
    ...
    def document(self) -> dict[str, Any]:
        return {
            "schema_version": "alc.ocr_proofread.request.v1",
    ...
    def from_document(cls, value: Mapping[str, Any]) -> "ProofreadConfig":
        if value.get("schema_version") != "alc.ocr_proofread.request.v1":
            ...
            if context.resume_input is None:
                ...
                return Paused(
                    Awaiting(
                        ...
                        True,
                        request_ref,
                        "alc.ocr_proofread.review_input.v1",
            ...
            if isinstance(outcome, LLMPaused):
                if outcome.reason is ResumeReason.EXECUTION_INTERRUPTED:
                    return UnitResult(
                        ...
                        "succeeded",
                        {
                            "schema_version": "alc.ocr_proofread.boundary_result.v1",
...
"""
            ...
            if (
                ...
                return Paused(
                    Awaiting(
                        ...
                        True,
                        request_ref,
                        "alc.ocr_proofread.boundary_review_input.v3",
    ...
    def _audit_awaiting(self, context: RunContext, pages: list[dict[str, Any]]) -> Awaiting:
        ...
        return Awaiting(
            ...
            True,
            request_ref,
            "alc.ocr_proofread.audit_input.v1",
            {
    ...
    def _publish(
        ...
        chunks = [
            "<!-- Generated by ALC OCR proofreading. -->",
...
def _validate_boundary_review_input(
    ...
    return {
        "schema_version": "alc.ocr_proofread.boundary_review_decisions.v3",
        "resume_key": key,
...
def _validate_review_input(
    ...
    return {
        "schema_version": "alc.ocr_proofread.review_decisions.v1",
        "resume_key": key,
...
def _validate_audit_input(
    ...
    result = {"schema_version": "alc.ocr_proofread.audit_decisions.v1", "resume_key": key}
