...
Read `manuals/alc-ocr-proofread.md` before the first command.
...
```bash
alc-ocr-proofread reconcile-boundaries --project-dir <project-dir> \
...
```bash
alc-ocr-proofread validate --project-dir <project-dir>
alc-ocr-proofread get-result --project-dir <project-dir>
```
