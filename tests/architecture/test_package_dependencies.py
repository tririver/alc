...
ALLOWED = {
    ...
    "arc_document": {"arc_jobs", "arc_llm"},
    "arc_paper": {"arc_document", "arc_jobs", "arc_llm"},
    "arc_render": {"arc_document"},
    "arc_domain": {"arc_jobs", "arc_llm", "arc_paper"},
    "arc_ocr_proofread": {"arc_document", "arc_jobs", "arc_llm"},
    "arc_translate": {"arc_document", "arc_jobs", "arc_llm", "arc_render"},
    "arc_companion": {
        "arc_document",
        "arc_jobs",
        "arc_llm",
